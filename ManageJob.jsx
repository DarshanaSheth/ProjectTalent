            ...
            <Card key={items._id}>
                ...
                <Card.Content extra>
                    ...
                    <Button.Group floated="right" size="mini">
                                    <Button icon='ban'content="Close" basic color='blue' onClick={() => this.closeJob(item._id)} />
                                    <Button icon='edit' content="Edit"  basic color='blue' onClick={() => this.editJob(item._id)} />
